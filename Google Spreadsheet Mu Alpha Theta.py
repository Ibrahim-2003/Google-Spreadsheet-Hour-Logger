...
SAMPLE_SPREADSHEET_ID_input = '1zQ1PCpIxhFf0RvcznkCAgNsDtmCHxKk_g2NGrTONu9k' #Put the ID of your Google Sheet here
...
r = open("timestamp_tracker.txt", "r")
tracker = r.read()
print(tracker)
...
f = open("timestamp_tracker.txt", "a")
i=0
